...
export default class Example7 extends Component {
  ...
  render() {
    let tableData = this.state.list.map((item) => {
      return (
        <tr key={item.id} className="bg-green-500 border-b border-green-400 text-black">
    ...
    return (
      <div className="overflow-x-auto relative shadow-md sm:rounded-lg">
        <table className="w-full text-sm text-left text-green-100 dark:text-green-100">
          <thead scope="col" class="py-3 px-6"ead className="text-xs text-black uppercase bg-green-600 dark:text-white">
            <tr>
              <th scope="col" class="py-3 px-6">Name</th>
              <th scope="col" class="py-3 px-6">Base Symbol</th>
              <th scope="col" class="py-3 px-6">Exchange Name</th>
              <th scope="col" class="py-3 px-6">Quote ID</th>
              <th scope="col" class="py-3 px-6">Price USD</th>
